...
public class GameManager : MonoBehaviour
{
    ...
    [Tooltip("To get what the player is")]
    public static GameObject getPlayer = null;
    ...
    private void Start()
    {
        ...
        //getPlayer = FindObjectOfType<ThirdPersonCharacterController>().gameObject;
    }
    ...
    public GameObject multiPlayer = null;
    ...
    private void Update()
    {
        UpdateUIElements();
        //DontDestroyOnLoad(player);
        if (multiPlayer = GameObject.Find("KnightPlayer"))
        {
            ...
            //Debug.LogError("If statement worked");
        }
        //player = GameObject.Find("KnightPlayer");
