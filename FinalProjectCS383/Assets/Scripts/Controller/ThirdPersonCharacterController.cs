...
public class ThirdPersonCharacterController : MonoBehaviour
{
    ...
    public enum PlayerState {Idle, Moving, Jumping, DoubleJumping, Falling, Dead, Attacking, Attack};
    ...
    void LateUpdate()
    {
        ...
        CentralizedControl(inputManager.horizontalMoveAxis, inputManager.verticalMoveAxis, inputManager.jumpPressed, inputManager.firePressed);
    }
    ...
    /// <param name="">"Whether or not the attack input has been pressed"</param>
    void CentralizedControl(float leftRightMovementAxis, float forwardBackwardMovementAxis, bool jumpPressed, bool firePressed)
    {
        ...
        {
            NormalControl(leftRightMovementAxis, forwardBackwardMovementAxis, jumpPressed, firePressed);
        }
    }
    ...
    /// <param name="rightCharacterMovement">The movement input along the vertical</param>
    /// <param name="jumpPressed">"Whether or not the jump input has been pressed"</param>
    /// <param name ="firePressed">"Whether or not the attack button has been pressed"</param>
    void NormalControl(float leftRightMovementAxis, float forwardBackwardMovementAxis, bool jumpPressed, bool firePressed)
    {
        ...
        if (inputManager.firePressed || Input.GetMouseButtonDown(0))
        {
