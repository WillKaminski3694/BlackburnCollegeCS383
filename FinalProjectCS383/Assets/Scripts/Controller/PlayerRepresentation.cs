...
public class PlayerRepresentation : MonoBehaviour {
    ...
    void ApplyAnimation()
    {
        ...
        // Attacking
        if(currentPlayerState == ThirdPersonCharacterController.PlayerState.Attacking)
        {
            representationAnimator.SetBool("Attacking", true);
        }
        else
        {
            representationAnimator.SetBool("Attacking", false);
        }

        // Attack
        if(currentPlayerState == ThirdPersonCharacterController.PlayerState.Attack)
        {
            representationAnimator.SetBool("Attack", true);
        }
        else
        {
            representationAnimator.SetBool("Attack", false);
        }
